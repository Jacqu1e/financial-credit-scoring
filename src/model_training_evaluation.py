...
def build_model(preprocessor, model_algorithm):
    """
    Ensambla el pipeline completo de preprocesamiento y modelo.
    """
    return Pipeline([
...
def summarize_classification(y_true, y_pred, model_name="Modelo"):
    """
    Calcula las métricas de evaluación adaptadas a clasificación multiclase.
    """
    metrics = {
        'Modelo': model_name,
...
if __name__ == "__main__":
    ...
    # 2. Identificar la columna objetivo automáticamente
